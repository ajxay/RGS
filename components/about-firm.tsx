  ...
  return (
    <section id="about" className="py-[100px]">
      <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-20">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-10 fig:gap-20">
          <div className="flex w-full flex-col gap-4 lg:min-w-0 lg:flex-1 fig:w-[562px] fig:flex-none">
          ...
          <div className="relative h-[240px] w-full overflow-hidden rounded-[16px] lg:h-[318px] lg:min-w-0 lg:flex-1 fig:w-[638px] fig:flex-none">
            <Image
              src="/images/about-a.jpeg"
              alt="RGS Legal partners in discussion around a table"
              width={800}
              height={450}
              sizes="(min-width: 1440px) 638px, (min-width: 1024px) 50vw, 100vw"
